      ...
      <Router>
        ...
        <UserProvider>
          <Routes>
            ...
            <Route path="/drugs/*" element={<Drug user={user} savedDrugs={savedDrugs} setSavedDrugs={setSavedDrugs} />} />
            ...
            <Route path="/mydrugs" element={<MyDrugs user={user} savedDrugs={savedDrugs} setSavedDrugs={setSavedDrugs}/>} />
